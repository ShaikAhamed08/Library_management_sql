...
CREATE TABLE publisher(PublisherName varchar(50), PublisherAddress varchar(100), Phone_No varchar(20));
CREATE TABLE books(book_Title varchar(50), BookPublisherName varchar(100));
CREATE TABLE library_branch(BranchName varchar(50), BranchAddress varchar(100));
CREATE TABLE customer(name varchar(50), address varchar(100), phone varchar(20));
CREATE TABLE loan(book_id int, branch_id int, card_No int, DateOut Date, DateDue Date);
CREATE TABLE book_copies(book_id int ,Branch_ID int , no_of_copies int);
CREATE TABLE tbl_book_authors(Book_ID int,Author_Name varchar (50));

INSERT INTO publisher
(PublisherName , PublisherAddress , Phone_No)
		VALUES
...
-- INSERT INTO loan
-- 		(book_id, branch_id, card_No, DateOut, DateDue)
-- 		VALUES
-- 		('1','1','1','1/1/18','2/2/18'),
-- 		('2','1','1','1/1/18','2/2/18'),
-- 		('3','1','1','1/1/18','2/2/18'),
